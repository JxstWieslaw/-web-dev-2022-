...
meshContainer.position.set(-2.5, 1, -.5);
...
function sports_2() {
  ...
  loader.load(
    ...
    function (gltf) {
      ...
      sports.scale.set(1, 1, 1);

      // Offset the y position a bit
      sports.position.set(0, -2, 0);
...
makeUI();
var container;
// var containerSprite = new THREE.Sprite();
...
function makeUI() {
  ...
  container.position.set(0, 50, 0);
  container.rotation.y = 190;
  scene.add(container);
  ...
  const buttonBlock = new ThreeMeshUI.Block({
    ...
    fontTexture: "https://cdn.glitch.global/16c608ec-5553-4ef3-a3af-cb050de7eae9/Roboto-msdf.png?v=1653659225236",
    fontSize: 0.07,
    padding: 0.02,
    borderRadius: 0.11,
  });
  ...
  loader.load("https://cdn.glitch.global/16c608ec-5553-4ef3-a3af-cb050de7eae9/spiny_bush_viper.jpg?v=1653659225468", (texture) => {
...
function onClick(event) {
  ...
  if (intersects.length > 0) {
    ...
    // }
      ...
      if(intersects[0].object.name ==="Icosphere.018_0" || intersects[0].object.name ==="Icosphere.018_1" || intersects[0].object.name ==="Icosphere.018_2"  ){
        container.position.set(-2.5,-.2, 1);
        container.visible = meshContainer.visible =true;
         
    }
    
     if(intersects[0].object.name === "Icosphere.022_0" || intersects[0].object.name ==="Icosphere.022_1" || intersects[0].object.name ==="Icosphere.022_2"){
      container.position.set(-1.8, -.2, -1.5);
      container.visible = meshContainer.visible =true;
    }
