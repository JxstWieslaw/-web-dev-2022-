...
import {
  LowerClothObject,
  lowerClothes_Objects,
} from "./Models/Clothes/Lower/swatch";
import {
  UpperClothObject,
  upperClothes_Objects,
} from "./Models/Clothes/Upper/swatch";
import {
  LowerCloth1,
  LowerCloth2,
  LowerCloth3,
  ...
  LowerCloth7,
  LowerCloth8,
} from "./Models/Clothes/Lower/objects";
import {
  UpperCloth1,
  UpperCloth3,
  UpperCloth4,
  ...
  UpperCloth8,
  UpperCloth9,
} from "./Models/Clothes/Upper/objects";
...
import {
  ...
  BoyHairstyle11,
  BoyHairstyle12,
} from "./Models/HairStyle/Boy/objects";
import {
  Mouth1,
  Mouth2,
  Mouth3,
...
function Configurator({ history }) {
  ...
  const [appliedBeard, setAppliedBeard] = useState("BE2");
  const [appliedCheek, setAppliedCheek] = useState("CK9");

  const [appliedEyes, setAppliedEyes] = useState("ES7");
  const [appliedEyeBrow, setAppliedEyeBrow] = useState("EBS6");
  ...
  const [appliedUpperClothes, setAppliedUpperClothes] = useState("UCS9");
  const [appliedLowerClothes, setAppliedLowerClothes] = useState("LCS6");
      ...
      <div className="product-canvas">
        <Canvas flat linear>
          <Suspense fallback={null}>
            ...
            {!clicked && <ambientLight intensity={0.3} />}

            {!clicked && <pointLight intensity={0.8} position={[10, 15, 10]} />}
            {!clicked && (
            ...
            {appliedBoyHairStyle === "BHS1" && appliedFace === "F4" && (
              <BoyHairstyle1 />
            )}
            {appliedBoyHairStyle === "BHS2" && appliedFace === "F4" && (
              <BoyHairstyle2 />
            )}
            {appliedBoyHairStyle === "BHS3" && appliedFace === "F4" && (
              <BoyHairstyle3 />
            )}
            {appliedBoyHairStyle === "BHS4" && appliedFace === "F4" && (
              <BoyHairstyle4 />
            )}
            {/* {appliedBoyHairStyle === "BHS5" && <BoyHairstyle5 />} */}
            {appliedBoyHairStyle === "BHS6" && appliedFace === "F4" && (
              <BoyHairstyle6 />
            )}
            {appliedBoyHairStyle === "BHS7" && appliedFace === "F4" && (
              <BoyHairstyle7 />
            )}
            {appliedBoyHairStyle === "BHS8" && appliedFace === "F4" && (
              <BoyHairstyle8 />
            )}
            {appliedBoyHairStyle === "BHS9" && appliedFace === "F4" && (
              <BoyHairstyle9 />
            )}
            {/* {appliedBoyHairStyle === "BHS10" && <BoyHairstyle10 />} */}
            {appliedBoyHairStyle === "BHS11" && appliedFace === "F4" && (
              <BoyHairstyle11 />
            )}
            {appliedBoyHairStyle === "BHS11" && appliedFace === "F4" && (
              <BoyHairstyle12 />
